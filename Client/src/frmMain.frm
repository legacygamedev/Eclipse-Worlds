...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picForm 
      ...
      Begin VB.PictureBox picEquipment 
         ...
         Visible         =   0   'False
         Width           =   2925
         Begin VB.PictureBox picEquipFace 
            Appearance      =   0  'Flat
            AutoRedraw      =   -1  'True
            BackColor       =   &H00000000&
            BorderStyle     =   0  'None
         ...
         Begin VB.PictureBox picVisEquip 
            ...
            Width           =   1440
         End
         Begin VB.Label lblEquipCharName 
            Alignment       =   2  'Center
            AutoSize        =   -1  'True
            BackStyle       =   0  'Transparent
            Caption         =   "Empty"
...
Private Sub lstTitles_Click()
    ...
    If Not lstTitles.ListIndex = 0 Then
        For i = 1 To MAX_TITLES
            ...
            End If
        Next
        Call SendSetTitle(player(MyIndex).title(lstTitles.ListIndex))
    Else
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = vbKeyReturn Then
        If picChatbox.Visible = True Then
    ...
    If frmMain.picDialogue.Visible Then
        If lblDialogue_Button(1).Visible = True Then
            If KeyAscii = vbKeyReturn = True Then Call lblDialogue_Button_Click(1)
        Else
            If KeyAscii = vbKeyReturn = True Then Call lblDialogue_Button_Click(2)
            If KeyAscii = vbKeyEscape = True Then Call lblDialogue_Button_Click(3)
        End If
    End If
...
Private Sub picInventory_DblClick()
    ...
    If InvNum <> 0 Then
        ...
        If Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_NONE Or Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_CURRENCY Or Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_AUTOLIFE Then
...
Private Sub picInventory_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    ElseIf Button = 2 Then
        If InvNum > 0 And InvNum <= MAX_INV Then
            ...
            ' Build the list
            If Not Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_NONE And Not Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_CURRENCY And Not Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ITEM_TYPE_AUTOLIFE Then
...
Private Sub picVisEquip_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Dim EqNum As Long
    Dim X2 As Long, Y2 As Long
